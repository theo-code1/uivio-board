...
const FeaturesSection = () => {
  ...
  return (
    <section className="md:h-[160dvh] lg:h-[200dvh] max-w-screen bg-[#F5F5F7] font-inter-medium">
        <h1 className="headline-gradient text-4xl md:text-6xl lg:text-7xl text-center bg-gray-bg border pt-24 pb-40 font-inter-bold font-bold lg:leading-20">Powerful features<br />to boost your productivity</h1>

        <div className="Features-cards flex flex-col gap-6 max-w-screen bg-white py-40">
            <div className="first-row flex flex-col md:flex-row gap-10 md:gap-6 mx-auto w-[90dvw] mdw-[75%] lg:w-[60dvw]">
                ...
                <FeaturesCards 
                    ...
                    />
                <FeaturesCards 
                    ClassName={`bg-[#2997FF] rounded-4xl flex flex-col gap-2 pt-24 md:pt-48 pb-8 w-[90%] md:w-[60%] px-8 text-white mx-auto md:mx-0`} 
