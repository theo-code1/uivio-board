...
function DesignToWorkflow() {
    ...
    return(
        <section className="bg-[#F5F5F7] max-w-screen h-auto pb-64 font-inter-regular pt-48 flex flex-col gap-44">
            <h1 className="design-headline text-4xl md:text-6xl lg:text-7xl w-[90%] translate-x-[5%] md:translate-x-0 md:w-auto font-inter-bold font-bold text-center lg:leading-20">
